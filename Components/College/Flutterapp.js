...
const Flutterapp = () => {
    ...
    const handlePress = () => {
        Linking.openURL("https://youtube.com/playlist?list=PLUhfM8afLE_OaJOVXCboP9PRuhvirFqgk&si=pLHsnQqg8X4zJARz");
    };
    const source = { uri: 'bundle-assets://pdf/flutterapp.pdf' };
