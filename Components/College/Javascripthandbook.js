...
const Javascripthandbook = () => {
    ...
    const handlePress = () => {
        Linking.openURL("https://youtu.be/cpoXLj24BDY?si=NManjBb1u6NtTyBB");
    };
const source = { uri: 'bundle-assets://pdf/javascript-handbook.pdf' };
...
export default Javascripthandbook;
