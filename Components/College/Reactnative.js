...
const Reactnative = () => {
    ...
    const handlePress = () => {
        Linking.openURL("https://youtube.com/playlist?list=PL8p2I9GklV468O2wk-n8Q1KmtMhnHHj4C&si=ukv8N6DgcR00OKyD");
    };
const source = { uri: 'bundle-assets://pdf/react_native_tutorial.pdf' };
