...
const Css = () => {
    ...
    const handlePress = () => {
        Linking.openURL("https://youtube.com/playlist?list=PLfEr2kn3s-bpXj_TMONjRwasyjiFgEwj0&si=3pXevIAFQBWpA08U");
    };
const source = { uri: 'bundle-assets://pdf/nextjs_tutorial.pdf' };
